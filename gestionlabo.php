<?php
	include_once 'classes/laboratoire.php';
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-stethoscope fa-fw"></i> Gestion des laboratoires<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Gestion des laboratoires</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
