                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                             ...
                             <form role="form" method ="POST" action="ajoutlabo.php">
                                        ...
                                        <div class="form-group">
                                             <input type="text" name ="type" class="form-control" placeholder="Veuillez entrez le type">
									  ...
									  <input type="reset" class="btn btn-primary" value="Annuler" onclick="window.location.replace("../gestionlabo.php")">
