<?php
	include_once 'classes/personnels.php';
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="gestionmed.php">Liste médecin</a>
                            </li>
                            <li>
					 ...
					 <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="gestionmed.php">Liste laboratoires</a>
                            </li>
                            <li>
                                <a href="ajoutmed.php">Nouvlle laboratoire</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                              ...
                              <form role="form" method ="POST" action="modifper.php">
                                        <?php
