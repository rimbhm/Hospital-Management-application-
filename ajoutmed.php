                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
					 ...
					 <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="gestionperso.php">Liste personnel</a>
                            </li>
                            <li>
					 ...
					 <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="gestionequ.php">Liste équipements</a>
                            </li>
                            <li>
                                <a href="ajoutequ.php">Nouvlle équipement</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           ajouter un nouveaux medecin
                        </div>
                        <div class="panel-body">
						
                            <div class="table-responsive">
                               
                             <form role="form" method ="POST" action="ajouttmedecin.php">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name ="specialite" class="form-control" placeholder="Veuillez entrez la Specialite" required>
                                        </div>
                                        <div class="form-group">
