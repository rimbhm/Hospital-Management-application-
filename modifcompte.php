...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="accmed.php"><i class="fa fa-home fa-fw"></i>Accueil</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-stethoscope fa-fw"></i> Mon espace médecins<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="consultmed.php">Consulter profil</a>
                            </li>
                            <li>
                                <a href="modifcompte.php">Modifier profil</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                              ...
                              <form role="form" method ="POST" action="modifcp.php">
                                        <?php
